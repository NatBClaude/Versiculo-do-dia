const VERSES = [
  ...
  { texto: "Não temas, porque eu sou contigo; não te assombres, porque eu sou o teu Deus; eu te fortaleço, e te ajudo, e te sustento com a destra da minha justiça.", referencia: "Isaías 41:10", musica: { titulo: "Não Temerei", artista: "Gabriela Rocha" }, estudo: "Deus fala diretamente ao Seu povo amedrontado, prometendo presença, força e sustento. O medo é reconhecido, mas não tem a palavra final. Pergunte-se: o que você tem enfrentado sozinho que poderia entregar a Deus hoje? As três promessas — fortalecer, ajudar e sustentar — cobrem diferentes tipos de necessidade: força para começar, apoio no meio do caminho e sustento até o fim." },
  ...
  { texto: "Mas os que esperam no Senhor renovarão as forças, subirão com asas como águias; correrão, e não se cansarão; caminharão, e não se fatigarão.", referencia: "Isaías 40:31", musica: { titulo: "Renova-me", artista: "Aline Barros" }, estudo: "A promessa é para os que 'esperam no Senhor' — a palavra original sugere expectativa ativa, não passividade. Voar, correr e andar descrevem diferentes ritmos de vida que Deus sustenta. Pense: em que fase você está agora, e está bem com isso? Esperar no Senhor, nesse contexto, é uma postura de confiança ativa em meio ao cansaço — o texto reconhece que até os jovens se cansam (40:30), mas promete renovação a quem espera." },
  { texto: "Este é o dia que fez o Senhor; regozijemo-nos, e alegremo-nos nele.", referencia: "Salmos 118:24", musica: { titulo: "Este É o Dia", artista: "Coral tradicional" }, estudo: "O salmo celebra a vitória e a fidelidade de Deus mesmo depois de rejeição. Escolher se alegrar é um ato de fé, não apenas reação às circunstâncias. Avalie: você tem recebido cada dia como algo 'feito pelo Senhor'? Esse mesmo salmo é citado por Jesus a respeito de si mesmo (Mateus 21:42), ligando a alegria do dia à obra de salvação que Deus realiza." },
  ...
  { texto: "Não andeis ansiosos por coisa alguma; antes, as vossas petições sejam em tudo conhecidas diante de Deus.", referencia: "Filipenses 4:6", musica: { titulo: "Fica Tranquilo", artista: "Ana Nóbrega" }, estudo: "O mandamento é claro: não andar ansioso por nada. A alternativa proposta não é ignorar o problema, mas trazê-lo a Deus com oração e ação de graças. Reflita: qual ansiedade você pode transformar em oração hoje? A instrução combina três elementos — oração, súplica e ação de graças — mostrando que gratidão faz parte de como entregamos nossas preocupações." },
  ...
  { texto: "Sabemos que todas as coisas cooperam para o bem daqueles que amam a Deus.", referencia: "Romanos 8:28", musica: { titulo: "Deus Sabe o Que Faz", artista: "Aline Barros" }, estudo: "O contexto fala de sofrimentos presentes comparados à glória futura — a promessa não é que tudo é bom, mas que Deus opera até o que é ruim para o bem de quem o ama. Reflita: você consegue enxergar a mão de Deus mesmo nas dificuldades atuais? A promessa é feita especificamente 'aos que são chamados segundo o seu propósito' — não é uma garantia genérica, mas para quem caminha com Deus." },
];
